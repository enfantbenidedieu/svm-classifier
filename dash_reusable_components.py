...
def NamedSlider(name, **kwargs):
    return html.Div(
        ...
        children=[
            html.P(f"{name} :", style={'font-weight':'bold','font-family':'Times New Roman'}),
...
def NamedDropdown(name, **kwargs):
    return html.Div(
        ...
        children=[
            html.P(children=f"{name} :", style={"margin-left": "3px",'font-weight':'bold','font-family':'Times New Roman'}),
            dcc.Dropdown(**kwargs),
        ],
    )
...
def NamedRadioItems(name, **kwargs):
    return html.Div(
        style={"padding": "20px 10px 25px 4px"},
        children=[html.P(children=f"{name} :", style = {'font-family':'Times New Roman'}), dcc.RadioItems(**kwargs)],
    )
